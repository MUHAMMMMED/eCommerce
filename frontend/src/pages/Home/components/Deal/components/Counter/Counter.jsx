  ...
  return (
    <>
      <div className='detail-timer-row'>
        <div className='detail-timer-row-number'>{timeLeft.days}</div>
        <div className='detail-timer-row-text'>يوم</div>
      </div>

      <div className='detail-timer-row'>
        <div className='detail-timer-row-number'>{timeLeft.hours}</div>
        <div className='detail-timer-row-text'>الساعه</div>
      </div>

      <div className='detail-timer-row'>
        <div className='detail-timer-row-number'>{timeLeft.minutes}</div>
        <div className='detail-timer-row-text'>الدقيقه</div>
      </div>

      <div className='detail-timer-row'>
        <div className='detail-timer-row-number'>{timeLeft.seconds}</div>
